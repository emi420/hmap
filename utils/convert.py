...
parser.add_argument("-in", "--file-in", dest="file_in",
                    help="Input file")

parser.add_argument("-out", "--quiet",
                    dest="file_out", default="",
                    help="Output file")

parser.add_argument("-layer", "--layer", dest="layer",
                    help="Layer")

parser.add_argument("-driver", "--driver", dest="driver",
                    help="Driver (GeoJSON)", default="GeoJSON")
